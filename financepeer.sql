...
--
-- Dumping data for table `data_json`
--

INSERT INTO `data_json` (`userId`, `id`, `title`, `body`) VALUES
...
INSERT INTO `user_register` (`user_id`, `username`, `email_id`, `contact_number`, `password`, `re_password`) VALUES
(4, 'John', 'john@gmail.com', '9852365141', '$2y$10$thisismywayforpassworOkV4E8PRjQUtS6IQAI76/Pjry9TzIc7S', '$2y$10$thisismywayforpassworOkV4E8PRjQUtS6IQAI76/Pjry9TzIc7S');
